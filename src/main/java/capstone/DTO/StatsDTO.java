...
public class StatsDTO {
    ...
    public StatsDTO(Integer playerId, Integer gamesPlayed, Integer goals,
                    Integer assists, Integer points, Integer plusMinus,
                    Integer shots, Integer wins, Integer losses, Integer OTL,
                    Integer shutouts, Double SVPercent, Double GAA,
                    Integer saves, Integer shotsAgainst, Integer goalsAgainst) {
